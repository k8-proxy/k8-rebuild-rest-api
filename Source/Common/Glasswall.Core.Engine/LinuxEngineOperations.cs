...
namespace Glasswall.Core.Engine
{
    ...
    public class LinuxEngineOperations : IGlasswallFileOperations, IDisposable
    {
        private const string Libc = @"lib/linux/libglasswall.classic.so";
